...
function funcContent() {
    for (n = 0; n < x.length; n++) {
        document.write("<div class='row d-flex justify-content-center' id='post'><div class='col-md-3 text-white'><img src='assets/blog-imgs/" + x[n].getElementsByTagName("imagem")[0].childNodes[0].nodeValue + "'width='300'></div><div class='col-md-6 text-white'><div id='noticiaTitulo'><a href='./post.html?posicao=" + n + "'>" + "<h1>" + x[n].getElementsByTagName("titulo")[0].childNodes[0].nodeValue +"</h1></a></div> <p class='text-white'>" + x[n].getElementsByTagName("corpo")[0].childNodes[0].nodeValue.substr(0, 250) + "</p></div></div>");
    }
}
...
function funcPost() {
    ...
    document.write("<div id='background-texto'><div id='postagemBloco'>" + "<div id='postTitle'>" + x[i].getElementsByTagName("titulo")[0].childNodes[0].nodeValue + "</div><div id='postContent'><div class='text-center pb-3'><img src='assets/blog-imgs/"  + x[i].getElementsByTagName("imagem")[0].childNodes[0].nodeValue + "'width='500'></div>" +
